...
public class JSON2 {
    public static void main(String[] args) {
         ...
         */
        User user1 = new User("kim1", "9786", "a@test.com", "김일", "20");
        ...
        /*
            ...
            하지만 아직 메서드를 배우지 않았기 때무에 map만 생성하도록 하겠다
         */
        ...
        /*
            ...
            그리고 gson 객체에서도 toJson()이 있고 gsonBuilder에서도 toJson()이 있다는 점 또한 주목할 부분입니다.
        ...
        /*
            특정 Java 객체와 Json String data가 있다고 가정헀을 때 서로 왔다갔다하면서 고칠 수 있겠네요.
        ...
        /*
            ...
            잘 생각해보시면 jsonUser1을 선언할 떄 자료형을 String으로 잡았습니다.

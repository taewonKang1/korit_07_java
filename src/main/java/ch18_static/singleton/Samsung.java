...
/*
    방금 작성한ProductView와 인터넷에서의 레퍼런스를 참조하여
...
public class Samsung {
    ...
    private Samsung() {
        company = getClass().getSimpleName();       // 어차피 이거 결과값 Samsung 입니다.
        serialNumber = 20250000;                    // 즉 객체 생성시에 필드값을 초기화
    }
    ...
    public String createSerialNumber(String model) {
        ...
        // Main 단계에서 다수의 객체에서createSerialNumber()를 호출하더라도 전혀 serialNumber가 중복되지
        // 않을거라고 볼 수 있습니다.

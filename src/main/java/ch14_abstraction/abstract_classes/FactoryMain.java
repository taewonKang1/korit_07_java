...
public class FactoryMain {
    public static void main(String[] args) {
        ...
        factory1.showInfo();
        /*
            이상의 개념은 익명 클래스로, Java1.1 -> 근데 현재는 추후 학습할 람다식(Lamda Expression)으로
        ...
        // 부모 클래스에서 선언한 추상 클래스를 자식 클래스에서 구현부 작성한대로 작동되는지 호가인
        phoneFactory1.produce("아이폰17에어");
        phoneFactory1.manage();
        // 이번엔 부모 클래스이 일반 메서드를 호출
        ...
        System.out.println("현재 공장을 " + tabletFactory1.getName() + "으로 변경되었습니다.");

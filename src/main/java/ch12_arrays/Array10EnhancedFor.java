...
/*
    ...
    제약 :
        읽기만 되고, 쓰기가 안됩니다.(1 ~ 100까지 추출하는건 되는데
        집어넣는건 제한저긍로 된다 등)
...
public class Array10EnhancedFor {
    public static void main(String[] args) {
        ...
        // 1부터 200까지 대입하시오.
        // 일반 for문 형태로 1 2 3 4 5 6 ... 200으로 출력하시오.
        ...
        for(int number : nums) {
            ...
            // 39 실행
            // ... 200 대입
            // 39번 라인 실행하고, 마무리(마무리 시저믕 마지막 element 대입후
            // 반복 실행문 실행 후)
...
//        number = 201;  오류 발생
        ...
        String[] kims = { "김일", "김이", "김삼", "김사", "김오"};

        for (int i = 0; i < kims.length; i++) {
            System.out.print(kims[i] + " ");
        }
        System.out.println();

...
/*
    ...
    사람 객체가 생성되었습니다.
    사람이 두 발로 걷습니다,
    안녕하세요. 제이름은 여러분 이름이고 나이는 몇살 입니다.
    내년에는 몇 +1살이됩니다.
    여러분이름이 자바의 기초를 읽는 중입니다.
 */
public class Human extends Animal {
    ...
    public void read(String str) {
        System.out.println(getAnimalName() + "이 " + str + "를 읽는 중입니다.");
    }

    public void aboutMe() {
        System.out.println("안녕하세요. 제이름은 " + getAnimalName() + "이고 나이는 " + getAnimalAge() + "살 입니다.");
        System.out.println("내년에는 " + (getAnimalAge()+1) + "살이됩니다.");
    }

...
/*
    주석(comment) : Java 프로그램의 경우 폴더 및 파일의 전체 코드를 컴파일링 하는데,
        거기서 오류가 하나라도 발생하게되면 프로그램이 실행 x
...
public class Main {
    public static void main(String[] args) {
        System.out.println("안녕하세요, 제 이름은 강태원입니다.");
//        System.out.println(안녕하세요, 제이름은 강태원입니다); // 오류 발생
        ...
        /*
            ...
            그렇다면 권장되는 방식은 ? 데이터에 '변수'에 대입하고, 변수를 통해서
                명령을 내리는 방식
        ...
        String introduction = "안녕하세요, 저는 이번 국비 과정을 맡게 된 강태원입니다";
        ...
        char name2 = '태';
        char name3 = '원';
        System.out.println(name1 + name2 + name3); // 결과값 : 148417
        System.out.println('강' + '태' + '원'); // 결과값 : 148417

        System.out.println("" + name1 + name2 + name3); // 결과값 : 강태원
        /*
            이상의 코드에서 알 수 있는 점은 컴퓨터가 생각보다 멍청하다.
            개발자인 저희가 하나하나 지정을 해줘야 한다는 점입니다.
            '문자'와 '문자열'은 서로 다른 개념인데,
            문자(하나짜리)를 세 번 더했을 경우에는 더이사 문자가 아니라 문자열로 인식되기
            때문에 원하는 방식으로 출력되지 않습니다. 148417

            그렇게 때문에 76번 라인에서 sout()의 () 내부에 ""를 넣어주니까,
            원하는 결과값을 얻을 수 있었습니다.

            즉
            작은따옴표('')는 '문자'를 표시하기 위한 기호
            큰따옴표("")는 "문자열"을 표기하기 위한 기호
        ...
        System.out.println(123 + "1");          // 결과값 : 1231 예외적임.
        ...
        Integer width5 = 500;
        Integer width6 = 600;
        System.out.println(width5 + width6); // 근데 대문자로 시작하는 Integer가 있긴합니다.
         ...
         */
        System.out.println("원의 둘레 : " + pi * 43 * 2);
        ...
        // 이상의 코드에서 알 수 있는 점은 변수 + literal 의 형태로도 작성이 가능하다는 점입니다.
        ...
        // enter 키 위에 원화 표시있습니다. 원화표시가 한국에서만 먹히는 형태고 원래는 역슬러시만 표기되어있습니다.
        // \n -> 개행이 일어납니다.
        // \t -> 탭 친 효과가 일어납니다.
